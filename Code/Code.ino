...
void setup()
{
  ...
  if (!Sensor_0.begin(Wire, I2C_SPEED_FAST, MAX30105_ADDRESS))
  {
    // Serial.println("Sensor 1 was not found. Please check wiring/power. ");
    while (1);
  }
  ...
  if (!Sensor_1.begin(Wire, I2C_SPEED_FAST, MAX30105_ADDRESS))
  {
    // Serial.println("Sensor 2 was not found. Please check wiring/power. ");
    while (1);
  }
